...
export class CountrySelectPage implements OnInit {
  ...
  country_list_backup: any = this.country_list;
  ...
  ngOnInit () {
    console.log('ionViewDidLoad CountrySelectPage');
  }
  ...
  getItems(event: any) {
    ...
    this.country_list = this.country_list_backup;

    if (q != "") {
      this.country_list = this.country_list.filter (item => {
